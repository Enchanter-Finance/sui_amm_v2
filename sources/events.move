module enchanter_swap::events {
    ...
    public(friend) fun emit_create_pool_event<X, Y>(sender: address, pool_id: ID) {
    ...
    public(friend) fun emit_add_lp_event<X, Y>(
        sender: address,
        lp: u64,
        input_x: u64,
        input_y: u64,
    ...
    public(friend) fun emit_remove_lp_event<X, Y>(
        sender: address,
        lp: u64,
        min_x: u64,
        min_y: u64,
    ...
    /// Emit swap event
    public(friend) fun emit_swap_event<In, Out>(
